...
CREATE TABLE `status` (
  ...
  CONSTRAINT `status_chk_1` CHECK ((`IsOperational` in (0,1)))
...
INSERT INTO `status` VALUES (1,'Available',1),(2,'Occupied',0),(3,'Under Construction',0),(4,'Reserve',0),(5,'Closed',0),(6,'AvailableSoon',1);
